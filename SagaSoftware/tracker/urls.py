...
urlpatterns = [
     ...
     path("<slug:site_slug>/dashboard/",
          tracker_views.DashbaordView.as_view(), name="dashboard"),
     ...
     path("<slug:site_slug>/projects/project-members/<slug:project_key>/",
          tracker_views.project_members, name="members"),
